    ...
    <section className={styles.wrapper}>
      ...
      <div className={styles.mainContentContainer}>
        <div className={styles.description}>
          ...
          <p>
            Feel free to explore the website, find me on the 'Gram or Pinterest
      ...
      <div>
        ...
        <div className={`${styles.spiralText} ${nothingYouCouldDo.className}`}>
          <p>
            ...
            speeding through at nearly 500,000 mph. I am a blip of consciousness
            in a sea of possibility…
          </p>
          <p>
            Looking down to myself - to my own body and my own{' '}
            <span className={styles.heavyText}>belly</span> - reminds me that{' '}
            <span>I AM HERE</span> in this body experiencing all of this
            inexplicable richness. It is with this body and these hands that I
            alchemize my thoughts into both permanent and fleeting physical
            creations…
          </p>
          <Image
            src={spiralIcon}
        ...
        <div className={styles.signatureContainer}>
          <div className={`${styles.signature} ${styles.heavyText}`}>
            ...
            <p className={styles.italicText}>I make to know who I am. ✨</p>
            <p>
